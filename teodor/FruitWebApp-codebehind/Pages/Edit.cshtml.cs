...
namespace FruitWebApp.Pages
{
	public class EditModel : PageModel
    {
        ...
        public async Task OnGet(int id)
        {
            ...
            using HttpResponseMessage response = await httpClient.GetAsync("http://localhost:5050/fruitlist/"+id.ToString());
        ...
        public async Task<IActionResult> OnPost()
        {
            ...
            using HttpResponseMessage response = await httpClient.PutAsync("http://localhost:5050/fruitlist/" + FruitModels.id, jsonContent);
