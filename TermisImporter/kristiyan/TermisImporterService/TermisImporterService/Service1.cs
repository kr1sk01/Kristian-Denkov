...
namespace TermisImporterService
{
    public partial class Service1 : ServiceBase
    {
        ...
        private static string folderPath = @"C:\Users\cross\Documents"; // Change this to your desired folder path
        private static string failedFolderPath = @"C:\Users\cross\Documents\failed_to_process"; // Change this to your desired failed folder path
        private static string succeededFolderPath = @"C:\Users\cross\Documents\succeeded_to_process"; // Change this to your desired succeeded folder path

        private static string logDirectory = AppDomain.CurrentDomain.BaseDirectory;
        private static string logFileName = @"Log\app.log";
